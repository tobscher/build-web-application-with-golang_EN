...
- Install LiteIDE
	...
	You need to install Go first, then download the version of your operating system. Uncompress the package to direct use.
- Install gocode
...
6. Congratulations! speedbar is closed as deafult, cut comment symbols in line `;;(speedbar 1)` to have this feature, or you can have it through `M-x speedbar`.
