#Object-oriented
We talked about function and struct in last two sections, but have you ever thought use functions as fields of struct? In this section, I will introduce you another form of method that has receiver, which is called `method`.
